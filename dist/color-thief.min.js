 ...
 * @license
 */
var iAmOnNode=!1,Canvas,Image,fs;process&&process.execPath&&(iAmOnNode=!0),iAmOnNode&&(Canvas=require("canvas"),Image=Canvas.Image,fs=require("fs"));var CanvasImage=function(a){var b;iAmOnNode?(this.canvas=new Canvas,b=new Image,a instanceof Buffer?b.src=a:b.src=fs.readFileSync(a)):(this.canvas=document.createElement("canvas"),document.body.appendChild(this.canvas),b=a),this.context=this.canvas.getContext("2d"),this.width=this.canvas.width=a.width,this.height=this.canvas.height=a.height,this.context.drawImage(a,0,0,this.width,this.height)};CanvasImage.prototype.clear=function(){this.context.clearRect(0,0,this.width,this.height)},CanvasImage.prototype.update=function(a){this.context.putImageData(a,0,0)},CanvasImage.prototype.getPixelCount=function(){return this.width*this.height},CanvasImage.prototype.getImageData=function(){return this.context.getImageData(0,0,this.width,this.height)},CanvasImage.prototype.removeCanvas=function(){this.canvas.parentNode.removeChild(this.canvas)};var ColorThief=function(){};/*!
